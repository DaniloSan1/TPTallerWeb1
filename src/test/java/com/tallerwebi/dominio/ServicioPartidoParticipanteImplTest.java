...
public class ServicioPartidoParticipanteImplTest {
        ...
        public void deberiaActualizarElEquipoDeUnParticipanteExistente() throws ParticipanteNoEncontrado {
                ...
                PartidoParticipante partidoParticipante = servicioPartidoParticipanteImpl.actualizarEquipo(
                                Mockito.anyLong(),
                                EquipoEnum.EQUIPO_2.toString());
                assertEquals(1L, partidoParticipante.getId());
                assertEquals(EquipoEnum.EQUIPO_2, partidoParticipante.getEquipo());
        }
